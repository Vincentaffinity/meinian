...
public class SMSUtils {
    ...
    public static void sendShortMessage(String phoneNumbers, String param) throws Exception{
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAI4GBJ1cnjXjcjKK9oT2q2";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "HSfHBRyzBDPqnMmlhhifoXzbf3FLy4";// 你的accessKeySecret，参考本文档步骤2
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("美年旅游");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_202813087");
